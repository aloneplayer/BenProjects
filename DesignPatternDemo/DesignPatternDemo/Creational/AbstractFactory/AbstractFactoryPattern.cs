...
namespace DesignPatternDemo.Creational.Abstract
{
    /// <summary>
    /// This pattern supports the creation of products that exist in families 
    /// and are designed to be produced together.
    /// The abstract factory can be refined to concrete factories,
    /// each of which can create different products of different types and in different combinations.
